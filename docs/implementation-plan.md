...
| Original visual/audio assets | Partial ROM-derived baseline | Player, Gunman, Bandit Bill, title/opening/briefing PNGs, and the Round 1 APU loop are extracted from the USA ROM with lib-jsnes; remaining sprites, terrain, and PCM assets are deterministic generated approximations |
