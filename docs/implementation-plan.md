...
| Original visual/audio assets | Partial ROM-derived baseline | Player, all ordinary enemy sprites, all six Boss sprites, title/opening/briefing/ending PNGs, and all Round/ending APU loops are extracted from the USA ROM; terrain, pickups, and SFX remain deterministic generated approximations |
