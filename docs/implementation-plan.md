...
| Original visual/audio assets | Partial ROM-derived baseline | Player, Gunman, all six Boss sprites, title/opening/briefing PNGs, and the Round 1 APU loop are extracted from the USA ROM; remaining ordinary sprites, terrain, and PCM assets are deterministic generated approximations |
