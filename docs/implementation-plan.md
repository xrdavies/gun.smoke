...
| Original visual/audio assets | Approximation baseline | Deterministic generated PNG/WAV resources load through WebGPU textures and AudioManager buses; ROM-derived reference frames run through lib-jsnes |
