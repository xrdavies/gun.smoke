...
| Original visual/audio assets | Partial ROM-derived baseline | Player, Gunman, and title/opening/briefing PNGs are extracted from the USA ROM with lib-jsnes; remaining sprites, terrain, and PCM assets are deterministic generated approximations |
