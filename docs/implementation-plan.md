...
| Original visual/audio assets | Partial ROM-derived baseline | Player, Gunman, all six Boss sprites, title/opening/briefing PNGs, and Round 1/2 APU loops are extracted from the USA ROM; remaining ordinary sprites, terrain, and PCM assets are deterministic generated approximations |
