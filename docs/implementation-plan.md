...
| Original visual/audio assets | Partial ROM-derived baseline | Player, all ordinary enemy sprites, all six Boss sprites, title/opening/briefing PNGs, and all six Round APU loops are extracted from the USA ROM; terrain, ending screen, pickups, and SFX remain deterministic generated approximations |
...
the next Round: 764 frames for Cutter and 765 for the other four regular Bosses,
replacing the former 1.5-second placeholder.
