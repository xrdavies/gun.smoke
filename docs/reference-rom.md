...
trace. The at351 code-7 phase-1 entry uses its own 569-frame trace; the at399
code-7 entry has a one-pixel fixed-point residue and uses a
separate 570-frame trace. The at207 code-8 `y=64` trace follows 371 measured frames, and a code 9 trace
