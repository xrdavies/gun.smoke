...
Each Round initialization at `$E82F` clears the global frame counter `$22`, and
`$E83D-$E845` reseeds the random registers before loading its event script. Boss arenas
