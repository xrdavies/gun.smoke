...
branches and release after 205/202 frames. Event `at=815,x=184,phase=0`
reaches the activation range later, throws at frame 116, and releases after 258
frames. Runtime binds those routes and throw frames to their event indexes
