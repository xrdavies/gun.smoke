...
captures the aim sector at that transition, then emits its first dispatch `0x30`
shot 16 frames later and four more every 16 frames. The integer aim selects one
of three five-heading
