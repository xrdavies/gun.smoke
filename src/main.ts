...
class GunSmokeGame {
  ...
  private updateUnit(unit: Unit, delta: number): void {
    ...
    if (unit.kind === "enemy") {
      const followsRomScroll = unit.romBehavior !== undefined && unit.romBehavior !== 2 && unit.romBehavior !== 5 && !(unit.enemyType === "backstabber" && (unit.romBehavior === 3 || unit.romBehavior === 8));
