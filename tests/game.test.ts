...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("continues Cutter from the sampled route into random movement", () => {
    ...
    expect([CUTTER_RANDOM_HANDOFF_SEGMENT_FRAMES, CUTTER_RANDOM_HANDOFF_GAIT]).toEqual([38, 0x87]);
  ...
  it("matches the traced Devil Hawk entrance", () => {
    ...
    expect([DEVIL_HAWK_RANDOM_HANDOFF_HEADING, DEVIL_HAWK_RANDOM_HANDOFF_SEGMENT_FRAMES, DEVIL_HAWK_RANDOM_HANDOFF_GAIT, DEVIL_HAWK_RANDOM_HANDOFF_ACTION_COUNTER]).toEqual([0x44, 71, 0x84, 14]);
