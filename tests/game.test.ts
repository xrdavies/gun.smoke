...
import { GUNMAN_BULLET_SPEED, GUNMAN_ENTRY_PATH_NES, GUNMAN_FIRST_SHOT_DELAY, GUNMAN_FLANK_LIFETIMES, GUNMAN_FLANK_SHOT_FRAMES, GUNMAN_LIFETIME, gunmanFlankPosition, gunmanOpeningY } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced flank Gunman variants", () => {
    expect(GUNMAN_FLANK_SHOT_FRAMES).toEqual({ 8: [309], 9: [399, 463] });
    expect(GUNMAN_FLANK_LIFETIMES).toEqual({ 8: 508 / NES_FRAME_RATE, 9: 826 / NES_FRAME_RATE });
