...
import { HATCHET_PATH_NES, hatchetCanThrow, hatchetPosition } from "../src/game-constants";
import { BANDIT_BILL_BULLET_SPEED, BANDIT_BILL_CRAWL_DURATION, BANDIT_BILL_DAMAGE_RECOVERY_DURATION, BANDIT_BILL_ENTRY_DURATION, BANDIT_BILL_ENTRY_END_Y, BANDIT_BILL_ENTRY_SPEED_Y, BANDIT_BILL_ENTRY_X_LANES, BANDIT_BILL_ENTRY_X_NES, BANDIT_BILL_ENTRY_Y, BANDIT_BILL_ENTRY_Y_NES, BANDIT_BILL_FIRST_VOLLEY_DELAY, BANDIT_BILL_HIT_STUN_DURATION, BANDIT_BILL_SHOT_INTERVAL, BANDIT_BILL_SHOTS_PER_VOLLEY, BANDIT_BILL_VOLLEY_GAP, banditBillCombatX, banditBillCombatY, banditBillOpeningY, banditBillProjectileVelocity, CUTTER_ENTRY_DURATION, CUTTER_ENTRY_END_Y, CUTTER_ENTRY_END_Y_NES, CUTTER_ENTRY_SPEED_Y, CUTTER_ENTRY_X_LANES, CUTTER_ENTRY_X_NES, CUTTER_ENTRY_Y, CUTTER_ENTRY_Y_NES, cutterCombatY, cutterOpeningY, DEVIL_HAWK_ENTRY_DURATION, DEVIL_HAWK_ENTRY_END_Y, DEVIL_HAWK_ENTRY_END_Y_NES, DEVIL_HAWK_ENTRY_SPEED_Y, DEVIL_HAWK_ENTRY_X_LANES, DEVIL_HAWK_ENTRY_X_NES, DEVIL_HAWK_ENTRY_Y, DEVIL_HAWK_ENTRY_Y_NES, DEVIL_HAWK_POST_ENTRY_X_HOLD, devilHawkCombatX, devilHawkOpeningY, FATMAN_JOE_ENTRY_DURATION, FATMAN_JOE_ENTRY_END_Y, FATMAN_JOE_ENTRY_END_Y_NES, FATMAN_JOE_ENTRY_X, FATMAN_JOE_ENTRY_X_NES, FATMAN_JOE_ENTRY_Y, FATMAN_JOE_ENTRY_Y_NES, fatmanJoeCombatY, fatmanJoeOpeningY, nesAimHeading, NINJA_BOSS_ENTRY_X_LANES, NINJA_BOSS_ENTRY_X_NES, NINJA_BOSS_ENTRY_Y_LANES, NINJA_BOSS_ENTRY_Y_NES, NES_WORLD_X_SCALE, NES_WORLD_Y_SCALE, WINGATE_ENTRY_DURATION, WINGATE_ENTRY_END_Y, WINGATE_ENTRY_END_Y_NES, WINGATE_ENTRY_X, WINGATE_ENTRY_X_NES, WINGATE_ENTRY_Y, WINGATE_ENTRY_Y_NES, WINGATE_SECOND_ENTRY_X, WINGATE_SECOND_ENTRY_X_NES, WINGATE_SECOND_ENTRY_Y, WINGATE_SECOND_ENTRY_Y_NES, WINGATE_SECOND_SPAWN_DELAY, wingateOpeningY } from "../src/game-constants";
...
import { WINGATE_ATTACK_INTERVAL, wingateAimHeading, WINGATE_BULLET_LIFETIME, WINGATE_BULLET_VELOCITIES_NES, wingateCanFire, WINGATE_DECOY_AIM_RANGE, WINGATE_ENTRY_RUSH_DELAY, WINGATE_ENTRY_RUSH_DURATION, WINGATE_ENTRY_RUSH_SPEED, WINGATE_FIRE_CHANCE, WINGATE_FIRST_SHOT_DELAY, WINGATE_MOVEMENT_SPEED, WINGATE_PROJECTILE_X_OFFSET_NES, WINGATE_PROJECTILE_Y_OFFSET_NES, WINGATE_REAL_AIM_RANGE, wingateProjectileVelocity, WINGATE_SECOND_FIRST_SHOT_DELAY, wingateCombatY } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced first Wingate entrance", () => {
    ...
    expect(WINGATE_ENTRY_RUSH_DELAY).toBeCloseTo(19 / NES_FRAME_RATE, 9);
    ...
    expect(WINGATE_DECOY_AIM_RANGE).toEqual([11, 21]);
    expect(WINGATE_REAL_AIM_RANGE).toEqual([14, 17]);
    expect(wingateCanFire(8 * NES_WORLD_X_SCALE, 0, 0, 6 * NES_WORLD_Y_SCALE, 0.25)).toBe(true);
    expect(wingateCanFire(8 * NES_WORLD_X_SCALE, 0, 0, 6 * NES_WORLD_Y_SCALE, 0.25, true)).toBe(false);
