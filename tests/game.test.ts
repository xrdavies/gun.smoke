...
import { advanceHatchet, createHatchetState, HATCHET_ENTRY_DEPTH_NES, HATCHET_ENTRY_PAUSE_FRAMES, HATCHET_LIFETIME, HATCHET_PATROL_BOUNDS_NES, HATCHET_THROW_FRAMES, HATCHET_TURN_FRAMES, hatchetCanThrow, hatchetCollisionProbeOffset, hatchetTurnHeading } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced Hatchet timing", () => {
    ...
    expect([hatchetCollisionProbeOffset(0), hatchetCollisionProbeOffset(8), hatchetCollisionProbeOffset(16), hatchetCollisionProbeOffset(24)]).toEqual([[0, -12], [12, 0], [0, 12], [-12, 0]]);
