...
import { WINGATE_BULLET_SPEED, WINGATE_FIRST_SHOT_DELAY, WINGATE_FIRST_VOLLEY_GAP, WINGATE_FIRST_VOLLEY_SIZE, WINGATE_MOVEMENT_SPEED, WINGATE_SECOND_FIRST_SHOT_DELAY, WINGATE_SECOND_VOLLEY_GAP, WINGATE_SECOND_VOLLEY_SIZE, WINGATE_SHOT_INTERVAL, wingateShotCooldown } from "../src/game-constants";
...
import { DEVIL_HAWK_FIREBALL_SPEED, DEVIL_HAWK_FIRST_VOLLEY_DELAY, DEVIL_HAWK_VOLLEY_INTERVAL } from "../src/game-constants";
import { NINJA_BOSS_ATTACK_INTERVAL, NINJA_BOSS_ENTRY_INVULNERABILITY, NINJA_BOSS_FIRST_ATTACK_DELAY, NINJA_BOSS_SHURIKEN_COUNT, NINJA_BOSS_SHURIKEN_SPEED } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced Rifleman volley timing", () => {
    expect(RIFLEMAN_ATTACK_STATE_FRAME).toBe(80);
  ...
  it("matches the traced Ninja Boss entrance", () => {
    ...
    expect(NINJA_BOSS_SHURIKEN_SPEED).toBe(405);
  });
  ...
  it("matches the traced first Wingate entrance", () => {
    ...
    expect(WINGATE_MOVEMENT_SPEED).toBeCloseTo((26.5 / 34) * NES_FRAME_RATE * NES_WORLD_X_SCALE, 9);
