...
import { GUNMAN_BOTTOM_BRANCH_FRAME, GUNMAN_BOTTOM_LIFETIMES, GUNMAN_BOTTOM_NEAR_DISTANCE_NES, gunmanBottomPosition, gunmanBottomRoute, GUNMAN_BOTTOM_SHOT_FRAMES, gunmanCanFire, GUNMAN_ENTRY_PATH_NES, GUNMAN_FIRST_SHOT_DELAY, GUNMAN_FLANK_LIFETIMES, GUNMAN_FLANK_SHOT_FRAMES, GUNMAN_LIFETIME, gunmanFlankPosition, gunmanOpeningY, gunmanProjectileVelocity, GUNMAN_TOP_SHOT_FRAMES } from "../src/game-constants";
import { RIFLEMAN_LIFETIME, RIFLEMAN_PATH_NES, riflemanCanAttack, riflemanPosition, RIFLEMAN_SIDE_LIFETIME, RIFLEMAN_SIDE_PATH_NES, RIFLEMAN_SIDE_SHOT_FRAMES, riflemanSidePosition, mediumProjectileVelocity } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced Gunman shot timing", () => {
    expect(GUNMAN_TOP_SHOT_FRAMES).toEqual([58, 250, 442]);
    expect(GUNMAN_FIRST_SHOT_DELAY).toBeCloseTo(58 / NES_FRAME_RATE, 9);
