...
import { BANDIT_BILL_BULLET_SPEED, BANDIT_BILL_ENTRY_SPEED_X, BANDIT_BILL_ENTRY_X, BANDIT_BILL_ENTRY_Y_LANES, BANDIT_BILL_ENTRY_Y_NES, BANDIT_BILL_FIRST_VOLLEY_DELAY, BANDIT_BILL_SHOT_INTERVAL, BANDIT_BILL_SHOTS_PER_VOLLEY, BANDIT_BILL_VOLLEY_GAP, NES_WORLD_X_SCALE } from "../src/game-constants";
