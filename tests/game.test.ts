...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced Gunman shot timing", () => {
    ...
    expect(GUNMAN_TOP_LIFETIMES_FRAMES).toEqual({ center: 549, left: 560, right: 560 });
