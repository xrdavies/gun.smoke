...
import { GUNMAN_BOTTOM_LIFETIMES, GUNMAN_BOTTOM_NEAR_DISTANCE_NES, gunmanBottomPosition, gunmanBottomRoute, GUNMAN_BOTTOM_SHOT_FRAMES, GUNMAN_BULLET_SPEED, GUNMAN_ENTRY_PATH_NES, GUNMAN_FIRST_SHOT_DELAY, GUNMAN_FLANK_LIFETIMES, GUNMAN_FLANK_SHOT_FRAMES, GUNMAN_LIFETIME, gunmanFlankPosition, gunmanOpeningY } from "../src/game-constants";
...
import { FIREBREATHER_PATH_NES, FIREBREATHER_PROJECTILE_OFFSET_NES, firebreatherPosition } from "../src/game-constants";
import { SPEAR_PATH_NES, SPEAR_PROJECTILE_OFFSET_NES, spearPosition } from "../src/game-constants";
...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced bottom-entry Gunman routes", () => {
    ...
    expect([gunmanBottomRoute(0, 55 * NES_WORLD_X_SCALE), gunmanBottomRoute(0, 56 * NES_WORLD_X_SCALE)]).toEqual(["near", "far"]);
