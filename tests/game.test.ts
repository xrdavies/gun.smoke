...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced ordinary Ninja entrance and retreat", () => {
    ...
    expect(ninjaTraceLifetime(80, 0, 4, 1, 2015, 210 / 256, 133 / 256)).toBeCloseTo(257 / NES_FRAME_RATE, 9);
    expect(ninjaTraceLifetime(56, 0, 4, 1, 2207, 36 / 256, 132 / 256)).toBeCloseTo(256 / NES_FRAME_RATE, 9);
    ...
    expect(ninjaTracePosition(256 / NES_FRAME_RATE, 80, 0, 4, 1, 2015, 210 / 256, 133 / 256)).toEqual([(96 + 62 / 256) * NES_WORLD_X_SCALE, (207 + 51 / 256) * NES_WORLD_Y_SCALE]);
    expect(ninjaTracePosition(255 / NES_FRAME_RATE, 56, 0, 4, 1, 2207, 36 / 256, 132 / 256)).toEqual([(85 + 160 / 256) * NES_WORLD_X_SCALE, (207 + 168 / 256) * NES_WORLD_Y_SCALE]);
    ...
    expect(ninjaTraceThrowFrames(4, 2015, 210 / 256, 133 / 256)).toEqual([116]);
    expect(ninjaTraceThrowFrames(4, 2207, 36 / 256, 132 / 256)).toEqual([116]);
