...
describe("Gun.Smoke vertical slice", () => {
  ...
  it("matches the traced flank Gunman variants", () => {
    ...
    expect(gunmanFlankPosition(7, 0, 64, 6, 0, false, undefined, 20, 0)).toEqual([0, 1]);
    expect(gunmanFlankPosition(7, 1 / NES_FRAME_RATE, 64, 6, 0, false, undefined, 20, 0)).toEqual([0.828125, 1]);
    expect(gunmanFlankPosition(7, 234 / NES_FRAME_RATE, 64, 6, 0, false, undefined, 20, 0)).toEqual([163.14453125, 111.5234375]);
    expect(gunmanFlankPosition(7, 917 / NES_FRAME_RATE, 64, 6, 0, false, undefined, 20, 0)).toEqual([200.046875, 186.8046875]);
